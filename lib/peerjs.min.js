                    ...
                    r.default.log("Listening for ICE candidates."), e.onicecandidate = function(e) {
                        ...
                        switch (e.iceConnectionState) {
                            ...
                            case "closed":
                                ...
                                break;
                            case "disconnected":
                                r.default.log("iceConnectionState changed to disconnected on the connection with " + t), n.connection.emit(c.ConnectionEventType.Error, new Error("Connection to " + t + " disconnected."));
                                break;
                            case "completed":
